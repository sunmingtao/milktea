...
public class SendShopAuthCodeServiceIT extends AbstractTransactionalJUnit4SpringContextTests{
	@Autowired
	private SendMobileAuthCodeService sendShopMobileAuthService;
	
	@Test
	public void testSendAuthenticationCodeToGoodMobile() throws ReachSmsQuotaLimitException{
		SmsResponse smsResponse = sendShopMobileAuthService.sendAuthenticationCode("1234567890");
	...
	public void testSendAuthenticationCodeToBadMobile() throws ReachSmsQuotaLimitException{
		SmsResponse smsResponse = sendShopMobileAuthService.sendAuthenticationCode("123");
	...
	public void testSmsQuotaServiceNoReachLimit() throws ReachSmsQuotaLimitException{
		...
		sendShopMobileAuthService.sendAuthenticationCode(mobile);
		sendShopMobileAuthService.sendAuthenticationCode(mobile);
		sendShopMobileAuthService.sendAuthenticationCode(mobile);
	}
